        ...
        (function (undo) {
            ...
            var UndoableEditSupport = (function () {
                ...
                UndoableEditSupport.prototype.addUndoableEditListener = function (l) {
                    /* addElement */ this.listeners.push(l);
                };
                /**
            ...
            var CompoundEdit = (function (_super) {
                ...
                CompoundEdit.prototype.addEdit = function (anEdit) {
                    if (!this.inProgress) {
                        ...
                        if (last == null) {
                            /* addElement */ this.edits.push(anEdit);
                        }
                    ...
                    while ((myKeys.hasMoreElements())) {
                        ...
                        if ((function (m, k) { if (m.entries == null)
                            ...
                            if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                return true;
                            } return false; })(this.postState, myKey) && ((function (m, k) { if (m.entries == null)
                            m.entries = []; for (var i = 0; i < m.entries.length; i++)
                            if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                return m.entries[i].value;
                            } return null; })(this.postState, myKey) === (function (m, k) { if (m.entries == null)
                            m.entries = []; for (var i = 0; i < m.entries.length; i++)
                            if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
                                return m.entries[i].value;
                            } return null; })(this.preState, myKey))) {
                            /* addElement */ uselessKeys.push(myKey);
                        }
                    }
                    ;
        ...
        (function (undo) {
            ...
            var UndoManager = (function (_super) {
                ...
                UndoManager.prototype.setLimit = function (l) {
                    if (!this.inProgress)
                        throw Object.defineProperty(new Error("Attempt to call UndoManager.setLimit() after UndoManager.end() has been called"), '__class', { configurable: true, value: 'java.lang.RuntimeException' });
                    this.limit = l;
                    this.trimForLimit();
                };
                /**
